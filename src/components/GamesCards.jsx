...
const GamesCards = ({ img, title, howToPlayButton }) => {
  return (
    <div className='min-w-[215px] sm:min-w-[235px] max-w-[348px] mb-[13px] min-h-[230px] sm:min-h-[289px] bg-[#071936] rounded-md overflow-hidden relative'>
      <div className='absolute top-0 left-0 transform -translate-y-1 z-10'>
       <span className='inline-block text-white text-center text-[12px] font-bold px-3 py-1 bg-badge rounded-tl-md rounded-t-lg rounded-br-xl -ml-1'>
        ...
        {/* Nova badge */}
        <span className='inline-block text-white text-center text-[12px] font-bold px-3 py-1 bg-secondBadge rounded-bl-xl rounded-tr-lg rounded-t-xl rounded-br-lg -ml-1'>
          Jogo Gratuito
        </span>
      </div>
      ...
      <div className='w-full min-h-[143px] overflow-hidden'>
       ...
       <div className='flex flex-col justify-between max-md:p-3 p-6 pt-2 h-[146px]'>
        <div>
          <h1 className='text-white font-bold max-md:text-sm text-base max-md:h-0 h-[77px] flex items-center'>
            {title}
          </h1>
        </div>
        <div className="flex  sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
        <button
           className='text-txtPrimeBlue text-sm min-h-[38px] max-md:mb-2 max-md:mt-10 font-medium px-3 py-[3px] rounded-md flex items-center justify-center bg-primeBlue hover:bg-primeBlueHover'>
          Resgatar jogo
        </button>
        {howToPlayButton && (
            <a
              href={howToPlayButton}
              target="_blank"
              rel="noopener noreferrer"
             className='text-white text-sm min-h-[38px] max-md:mb-2 max-md:mt-2 font-medium px-3 py-[3px] rounded-md flex items-center justify-center border border-howToPlayBorder hover:bg-howToPlay hover:text-white hidden md:flex'>
              Como jogar
            </a>
        )}
        </div>
...
GamesCards.propTypes = {
  ...
  howToPlayButton: PropTypes.string,
};

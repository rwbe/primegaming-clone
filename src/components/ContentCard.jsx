...
const ContentCard = ({ img, gameName, title }) => {
  ...
  return (
    <div className='mb-6 max-w-[348px] bg-card rounded-md overflow-hidden relative'>
      <div className='absolute top-0 left-0 transform -translate-y-1 z-10'>
      <span className='inline-block text-white text-center text-xs font-bold px-3 py-1 bg-badge rounded-tl-md rounded-t-lg rounded-br-xl -ml-1'>
          <svg
      ...
      <div className='flex items-start justify-center flex-col p-6 pt-4'>
        <div>
         <h1 className='text-gameName font-semibold hover:underline truncate cursor-pointer'>
            {gameName}
          </h1>
         <h1 className='text-white font-bold mb-2 flex flex-col' style={{ letterSpacing: '-0.5px', lineHeight: '1.2' }}>
            {title}
          </h1>
        </div>
